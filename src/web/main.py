...
async def read_player_profile(request: Request, player_name: str):
    ...
    if starts >= 18 and apps > 0 and starts == apps and mins >= 1400:
        rotation_risk_info = {"level": "Low", "badge": "Nailed Starter When Fit", "sub": "100% Fit Start Rate", "color": "emerald"}
    elif starts >= 30 or mins >= 2400:
        rotation_risk_info = {"level": "Low", "badge": "Nailed Starter", "sub": "100% Value Floor", "color": "emerald"}
    elif starts >= 14 and apps > 0 and starts >= 0.75 * apps and mins >= 1200:
        rotation_risk_info = {"level": "Low", "badge": "Regular Starter When Fit", "sub": "75%+ Fit Start Rate", "color": "emerald"}
        ...
        rotation_risk_info = {"level": "High", "badge": "Low Volume (Small Sample)", "sub": "20% Sample Discount", "color": "red"}
