...
async def read_player_profile(request: Request, player_name: str):
    ...
    if (starts >= 18 and apps > 0 and starts >= 0.85 * apps) or starts >= 30 or mins >= 2400:
        rotation_risk_info = {"level": "Low", "badge": "Nailed on when fit", "sub": "0% Rotation Discount", "color": "emerald"}
    elif starts >= 15 or mins >= 1800:
        rotation_risk_info = {"level": "Low", "badge": "Regular Starter", "sub": "5% Rotation Discount", "color": "emerald"}
    elif is_new_team and starts <= 14:
        rotation_risk_info = {"level": "Medium", "badge": "New Team", "sub": "10%-15% Integration Discount", "color": "amber"}
    elif starts <= 14 and apps > 0 and starts >= 0.75 * apps:
        rotation_risk_info = {"level": "Medium", "badge": "Small Sample", "sub": "15% Sample Discount", "color": "amber"}
    elif starts >= 15 and apps > 0 and starts < 0.50 * apps:
        rotation_risk_info = {"level": "High", "badge": "Large Rotation Risk", "sub": "20% Rotation Discount", "color": "red"}
    elif starts >= 15 or mins >= 1200:
        rotation_risk_info = {"level": "Medium", "badge": "Moderate Rotation Risk", "sub": "12% Rotation Discount", "color": "amber"}
    else:
        rotation_risk_info = {"level": "High", "badge": "Large Rotation Risk", "sub": "20% Rotation Discount", "color": "red"}
